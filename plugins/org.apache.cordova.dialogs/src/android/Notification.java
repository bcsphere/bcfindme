...
public class Notification extends CordovaPlugin {
  ...
  public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
    if (action.equals("beep")) {
      this.beep(args.getString(0));
    }else if(action.equals("stopBeep")){
      this.stopBeep(args.getString(0));
    }
  ...
  public void beep(String type) {
    ...
    if (type.equals("preventLost")) {
      isPreventLost = true;
    }

    if (type.equals("seekPhone")) {
      isSeekPhone = true;
    }
  ...
  public void stopBeep(String type){
    if (notification != null && notification.isPlaying()) {
      if (type.equals("closeAlarm")) {
        notification.stop();
        isTrue = false;
        isPreventLost = false;
        isSeekPhone = false;
      ...
      if (type.equals("preventLost") && !isSeekPhone) {
        notification.stop();
        isTrue = false;
        isPreventLost = false;
      }
